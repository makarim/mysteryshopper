...
('ji3j2r742s75ot5eiqu852lts7', 'kakapowu@gmail.com', 1263833300, '{"user_id":"1","user":"kakapowu@gmail.com","user_password":"78fb66bee250b7ea217610ba762aff18","user_email":"kakapowu@gmail.com","user_nickname":"administrator","user_sex":"1","user_state":"1","user_reg_time":"1263486757","user_reg_ip":"127.0.0.1","user_lastlogin_time":"1263628320","user_lastlogin_ip":"127.0.0.1","user_question":"","user_answer":"","autologin":"0","ticket":"ji3j2r742s75ot5eiqu852lts7"}');
...
--
-- 表的结构 `sp_assignment_rel`
--

CREATE TABLE IF NOT EXISTS `sp_assignment_rel` (
...
CREATE TABLE IF NOT EXISTS `sp_corporation` (
...
CREATE TABLE IF NOT EXISTS `sp_shopper` (
  ...
  `s_regip` varchar(15) NOT NULL,
  `s_lastvisit` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `s_lastvisitip` varchar(15) NOT NULL,
  PRIMARY KEY (`s_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `sp_shopper_ext` (
  `s_id` int(11) NOT NULL,
...
(1, 'kakapowu@gmail.com', '78fb66bee250b7ea217610ba762aff18', 'kakapowu@gmail.com', 'administrator', 1, 1, 1263486757, '127.0.0.1', 1263831860, '127.0.0.1', '', '');
