...
$GLOBALS['gLang']['workphone'] = '工作电话';
$GLOBALS['gLang']['homephone'] = '家庭电话';
...
$GLOBALS['gLang']['have_been_mystery_shopper'] = '你有做过神秘顾客的经验吗?';
$GLOBALS['gLang']['other_language'] = '其他常用语言';
$GLOBALS['gLang']['how_do_you_know_spot'] = '了解SPOT公司的渠道是:';
$GLOBALS['gLang']['introduced_by_friends'] = '朋友推荐';
$GLOBALS['gLang']['internet_advertisement'] = '网络平台';
$GLOBALS['gLang']['outdoor_advertising'] = '网上搜索';
$GLOBALS['gLang']['newspaper'] = '广告';
$GLOBALS['gLang']['television'] = '神秘顾客推荐';
$GLOBALS['gLang']['others'] = '其他';

$GLOBALS['gLang']['usual_dining_custom'] = '与你一起就餐的是';
$GLOBALS['gLang']['individual'] = '个人';
$GLOBALS['gLang']['with_family'] = '家人';
$GLOBALS['gLang']['with_friends'] = '朋友';
$GLOBALS['gLang']['with_colleagues'] = '同事';
$GLOBALS['gLang']['with_clients'] = '客户';
$GLOBALS['gLang']['lunchtimes'] = '外出午餐的次数：';
$GLOBALS['gLang']['lunch_average_bill'] = '午餐人均消费：';
$GLOBALS['gLang']['dinnertimes'] = '外出晚餐的次数：';
$GLOBALS['gLang']['dinner_average_bill'] = '晚餐人均消费：';
$GLOBALS['gLang']['to_restaurant_on_weekends'] = '双休日外出就餐的次数：';
$GLOBALS['gLang']['average_lunch_bill_on_weekends'] = '午餐人均消费：';
$GLOBALS['gLang']['average_dinner_bill_on_weekends'] = '晚餐人均消费：';
$GLOBALS['gLang']['company_name'] = '公司名称';
$GLOBALS['gLang']['food_you_like'] = '喜欢的怎样的菜系?';
$GLOBALS['gLang']['orderbyphone'] = '就餐之前，你有提前定位的习惯吗？';
$GLOBALS['gLang']['enjoy_vip_card'] = '你是否会经常使用折扣券/VIP卡？';
$GLOBALS['gLang']['meals_delivered'] = '周末选择电话外卖服务的次数是？';
$GLOBALS['gLang']['order_set'] = '是否会选择商务套餐?';
$GLOBALS['gLang']['lunch_delivered'] = '午餐选择电话外卖服务的次数是？';
$GLOBALS['gLang']['order_drink'] = '就餐是否经常点“饮品”?';
$GLOBALS['gLang']['primary_to_restaurant'] = '哪个选项是你外出就餐首先考虑的因素？';
$GLOBALS['gLang']['environment_'] = '环境氛围';
$GLOBALS['gLang']['convenient_transportation'] = '地理位置';
$GLOBALS['gLang']['product_and_service'] = '服务品质';
$GLOBALS['gLang']['price'] = '产品价位';
$GLOBALS['gLang']['others'] = '食物口味';
$GLOBALS['gLang']['your_interest'] = '您的兴趣爱好?';
$GLOBALS['gLang']['vehicle'] = '外出就餐，通常使用什么交通工具？';
$GLOBALS['gLang']['favorite_restaurant'] = '最喜欢的就餐地点?';
$GLOBALS['gLang']['receive_newsletter'] = '你是否愿意收到关于SPOT的最新活动信息？';
$GLOBALS['gLang']['metro'] = '地铁';
$GLOBALS['gLang']['bus'] = '大巴';
$GLOBALS['gLang']['taxi'] = '出租车';
$GLOBALS['gLang']['personal_auto'] = '私家车';
$GLOBALS['gLang']['company_car'] = '公家车';
$GLOBALS['gLang']['alipay_account'] = '支付宝账户';
$GLOBALS['gLang']['alipay_realname'] = '帐号姓名';
$GLOBALS['gLang']['bank_name'] = '银行名称';
$GLOBALS['gLang']['sub_branch_name'] = '支行名称';
$GLOBALS['gLang']['bank_account'] = '银行帐号';
