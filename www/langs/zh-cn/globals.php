...
$GLOBALS['gLang']['middle_school'] = '中学/高中';
$GLOBALS['gLang']['technical_secondary'] = '中专/肆业';
...
$GLOBALS['gLang']['internet_advertisement'] = '网络广告';
$GLOBALS['gLang']['outdoor_advertising'] = '户外广告';
$GLOBALS['gLang']['newspaper'] = '报纸';
$GLOBALS['gLang']['television'] = '电视';
$GLOBALS['gLang']['others'] = '其他';

$GLOBALS['gLang']['usual_dining_custom'] = '平常就餐习惯';
$GLOBALS['gLang']['individual'] = '个人';
$GLOBALS['gLang']['with_family'] = '家庭';
$GLOBALS['gLang']['with_friends'] = '朋友';
$GLOBALS['gLang']['lunchtimes'] = '一个星期的工作日中，午餐外出就餐次数?';
$GLOBALS['gLang']['lunch_average_bill'] = '午餐平均消费?';
$GLOBALS['gLang']['dinnertimes'] = '一个星期的工作日中，晚餐外出就餐次数?';
$GLOBALS['gLang']['dinner_average_bill'] = '晚餐平均消费?';
$GLOBALS['gLang']['to_restaurant_on_weekends'] = '一个星期的双休日中，外出就餐次数?';
